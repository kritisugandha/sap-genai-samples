...
REPORT zgoog_generate_content_veo.
...
* Populate relevant parameters
    ...
    ls_parameters-sample_count = p_no_vid.
...
* Call API method: aiplatform.projects.locations.publishers.models.predictLongRunning
    ...
    IF lo_client->is_success( lv_ret_code ).
      cl_demo_output=>display( |Videos generated and placed in GCS Bucket | && p_gcs ).
    ELSE.
